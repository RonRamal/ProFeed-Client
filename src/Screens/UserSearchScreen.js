...
class UserSearchScreen extends React.Component {
  ...
  render() {
    ...
    return (
      <Container>
        <ImageBackground
          source={require("../../assets/SearchBackgroundQuery.png")}
          style={styles.background}
        >
          <Text style={styles.StillHeader}></Text>
          ...
          <Item style={styles.HeaderButtons}>
            <Input
              ...
              onChangeText={(InputTitle) =>
                this.setState({ QueryInput: InputTitle })
              }
            />
          ...
          {loadingGif ? (
            ...
            <View style={{ flexDirection: "row", marginBottom: 15 }}>
              <Text
                style={{ fontSize: 20, fontWeight: "bold", color: "#1DA1F2" }}
              >
                {" "}
                HashTag
                <FontAwesomeIcon
              ...
              <Switch
                ...
                thumbColor={HashTag_BTN_Toggle ? "white" : "#f4f3f4"}
                onValueChange={this.HashTagClick}
                value={HashTag_BTN_Toggle}
              />
          ...
          <Content style={{ width: "100%", paddingLeft: 10 }}>
            {loadingGif ? (
              <View>
                <Image source={{ uri: loadingGif }} style={styles.tinyLogo} />
                  ...
                  {First_Stage_Toggle &&
                    MainCategories.map((item, key) => (
                      <CategoryButton
                        ButtonName={item}
                        key={key}
                        ClickEvent={this.SecondStageToggle}
                      />
                    ))}
                </View>
                  ...
                  {Second_Stage_Toggle &&
                    SubCategories.map((item, key) => (
                      <CategoryButton
                        ButtonName={item}
                        key={key}
                        ClickEvent={this.ThirdStageToggle}
                      />
                    ))}
                </View>
                  ...
                  {Third_Stage_Toggle &&
                    OtherCategories.map((item, key) => (
                      <CategoryButton
                        ButtonName={item}
                        key={key}
                        ClickEvent={this.SubmitBtnToggle}
                      />
                    ))}
                </View>
